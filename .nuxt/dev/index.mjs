globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/martins/Desktop/Projects/Braudit-Assessment/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file:///Users/martins/Desktop/Projects/Braudit-Assessment/node_modules/std-env/dist/index.mjs';
import { eventHandler, setHeaders, sendRedirect, defineEventHandler, handleCacheHeaders, createEvent, getRequestHeader, getRequestHeaders, setResponseHeader, createApp, createRouter as createRouter$1, lazyEventHandler, toNodeListener, getQuery, createError } from 'file:///Users/martins/Desktop/Projects/Braudit-Assessment/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///Users/martins/Desktop/Projects/Braudit-Assessment/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file:///Users/martins/Desktop/Projects/Braudit-Assessment/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { withoutBase, parseURL, withQuery, joinURL } from 'file:///Users/martins/Desktop/Projects/Braudit-Assessment/node_modules/ufo/dist/index.mjs';
import destr from 'file:///Users/martins/Desktop/Projects/Braudit-Assessment/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file:///Users/martins/Desktop/Projects/Braudit-Assessment/node_modules/scule/dist/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///Users/martins/Desktop/Projects/Braudit-Assessment/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/martins/Desktop/Projects/Braudit-Assessment/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/martins/Desktop/Projects/Braudit-Assessment/node_modules/hookable/dist/index.mjs';
import { hash } from 'file:///Users/martins/Desktop/Projects/Braudit-Assessment/node_modules/ohash/dist/index.mjs';
import { createStorage } from 'file:///Users/martins/Desktop/Projects/Braudit-Assessment/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/martins/Desktop/Projects/Braudit-Assessment/node_modules/unstorage/dist/drivers/fs.mjs';
import defu from 'file:///Users/martins/Desktop/Projects/Braudit-Assessment/node_modules/defu/dist/defu.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/martins/Desktop/Projects/Braudit-Assessment/node_modules/radix3/dist/index.mjs';

const _runtimeConfig = {"app":{"baseURL":"/","buildAssetsDir":"/_nuxt/","cdnURL":""},"nitro":{"envPrefix":"NUXT_","routeRules":{"/__nuxt_error":{"cache":false}}},"public":{"api":{}}};
...
const serverAssets = [{"baseName":"server","dir":"/Users/martins/Desktop/Projects/Braudit-Assessment/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/martins/Desktop/Projects/Braudit-Assessment","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/martins/Desktop/Projects/Braudit-Assessment/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/martins/Desktop/Projects/Braudit-Assessment/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/martins/Desktop/Projects/Braudit-Assessment/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_dNgMCp = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_dNgMCp, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_dNgMCp, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('/Users/martins/Desktop/Projects/Braudit-Assessment/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _virtual__headStatic = {"headTags":"<meta charset=\"utf-8\">\n<title>Braudit Assessment</title>\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n<link rel=\"icon\" href=\"/favicon.png\">\n<link rel=\"stylesheet\" href=\"https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600&family=Roboto:wght@400;500&display=swap\">","bodyTags":"","bodyTagsOpen":"","htmlAttrs":"","bodyAttrs":""};
